...
export interface ApiEntryEntry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content_type: Schema.Attribute.Enumeration<
      ['text_only', 'images_only', 'images_and_text', 'mixed_media']
    > &
      Schema.Attribute.Required &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    is_slide_show: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::entry.entry'> &
      Schema.Attribute.Private;
    magazine: Schema.Attribute.Relation<'manyToOne', 'api::magazine.magazine'>;
...
export interface ApiMagazineMagazine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cover_img: Schema.Attribute.Media<'images', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entries: Schema.Attribute.Relation<'oneToMany', 'api::entry.entry'>;
    epub_link: Schema.Attribute.String;
    issue_number: Schema.Attribute.String & Schema.Attribute.Required;
    issue_title: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    pdf_link: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'issue_number'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
